...
import skrueger.creator.gui.DpEntryTypeTableCellRenderer;
import skrueger.creator.gui.MegaByteTableCellRenderer;
...
public class DataPoolJTable extends JTable {
	...
	private final skrueger.atlas.dp.DataPool dataPool;
