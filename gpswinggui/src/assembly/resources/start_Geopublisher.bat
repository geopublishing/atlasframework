...
javaw -Xmx500m -Dfile.encoding=UTF8  -Djava.library.path=. -cp "%HOMEPATH%\.Geopublishing;%JAI%;%SWTJAR%;gpswinggui-${project.version}.jar" org.geopublishing.geopublisher.swing.GeopublisherGUI %CD% %~f1 %~f2 %~f3 %~f4 %~f5 %~f6 %~f7 %~f8 %~f9 %~f10 %~f11 %~f12 %~f13
