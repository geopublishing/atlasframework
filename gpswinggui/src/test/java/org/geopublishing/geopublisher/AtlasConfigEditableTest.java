...
public class AtlasConfigEditableTest {
	...
	@Test
	public void testGetUsedMaps() throws AtlasException, FactoryException, TransformException, SAXException, IOException, ParserConfigurationException {
		...
		// Should still be the same, as the new map is not added to the group tree yet
		...
		// Should still be +1 as the added map was already part of the group tree
