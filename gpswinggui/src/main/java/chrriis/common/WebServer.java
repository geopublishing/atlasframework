...
//            }
  ...
  protected static WebServerContent getWebServerContent(HTTPRequest httpRequest) {
    ...
    //MS-Hack.sn
    if ( parameter.endsWith("editor/filemanager/browser/default/browser.html") ) {
      return new WebServerContent() {
        @Override
        public InputStream getInputStream() {
         try {
           String template = IOUtil.readURLasString(
               new URL("http://localhost:" + Webserver.PORT + "/browser.html")
           );
