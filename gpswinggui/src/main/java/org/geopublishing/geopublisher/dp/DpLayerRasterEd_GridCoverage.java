...
public class DpLayerRasterEd_GridCoverage extends DpLayerRaster_GridCoverage2D implements
		DpEditableInterface {
	final static private Logger LOGGER = Logger
			.getLogger(DpLayerRasterEd_GridCoverage.class);
	 ...
	 * @throws IOException
	 */
	public DpLayerRasterEd_GridCoverage(Component owner, AtlasConfig ac, File file)
