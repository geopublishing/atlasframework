...
/**
 * Panel to show and manipulate boundaries of a rectangular object such as a
 * table cell.
 * 
...
class BoundariesPanel extends JPanel implements AttributeComponent {
	...
	public BoundariesPanel(Object attrKey) {
		...
		Util.addGridBagComponent(this, new JLabel(Util
				.getResourceString("topLabel")), g, c, 0, 0,
				GridBagConstraints.EAST);
		Util.addGridBagComponent(this, new JLabel(Util
				.getResourceString("rightLabel")), g, c, 2, 0,
				GridBagConstraints.EAST);
		Util.addGridBagComponent(this, new JLabel(Util
				.getResourceString("bottomLabel")), g, c, 0, 1,
				GridBagConstraints.EAST);
		Util.addGridBagComponent(this, new JLabel(Util
				.getResourceString("leftLabel")), g, c, 2, 1,
				GridBagConstraints.EAST);
	...
	private void addSizeSelector(GridBagLayout g, GridBagConstraints c,
		...
		SizeSelectorPanel ssp = new SizeSelectorPanel(attr, null, false,
				SizeSelectorPanel.TYPE_LABEL);
		Util
				.addGridBagComponent(this, ssp, g, c, x, y,
	...
	public AttributeSet getValue() {
		...
		if (!originalValue.equalsIgnoreCase(newValue)) {
			...
			Util.styleSheet().addCSSAttribute(set, (CSS.Attribute) key,
					newValue);
		}
		return set;
	}
