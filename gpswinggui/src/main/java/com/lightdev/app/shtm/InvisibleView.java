...
class InvisibleView extends View {
	 ...
	 *         point in the view >= 0. The <code>biasReturn</code> argument will
	 *         be filled in to indicate that the point given is closer to the
	 *         next character in the model or the previous character in the
	 *         model.
	 */
	@Override
