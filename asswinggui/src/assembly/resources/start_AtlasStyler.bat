...
javaw -Xmx500m -Dfile.encoding=UTF-8 -Djava.library.path=. -cp "%JAI%;%HOMEPATH_COMPL%\.Geopublishing;asswinggui-${project.version}.jar" org.geopublishing.atlasStyler.swing.AtlasStylerGUI %~f1 %~f2 %~f3 %~f4 %~f5 %~f6 %~f7 %~f8 %~f9 %~f10 %~f11 %~f12 %~f13 
